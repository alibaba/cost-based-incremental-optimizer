...
public enum BuiltInMethod {
  ...
  TVR_PHYSICAL_TABLE_SINK(EnumerableDefaults.class, "tvrPhysicalTableSink", Collection.class,
          Enumerable.class),
  TVR_PHYSICAL_TABLE_SPOOL(EnumerableDefaults.class, "tvrPhysicalTableSpool", Collection.class,
          Enumerable.class),
  TVR_PRINT_MESSAGE(EnumerableDefaults.class, "tvrPrintMessage", Enumerable.class, String.class),
