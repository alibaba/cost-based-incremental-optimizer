 ...
 */
public final class TvrLogicalTableScan extends LogicalTableScan {
  //~ Constructors -----------------------------------------------------------
   ...
   */
  public TvrLogicalTableScan(RelOptCluster cluster, RelTraitSet traitSet,
                             RelOptTable table, TimeInterval timeInterval) {
   ...
   */
  public static TvrLogicalTableScan create(RelOptCluster cluster,
                                           final RelOptTable relOptTable, TimeInterval timeInterval) {
    ...
    return new TvrLogicalTableScan(cluster, traitSet, relOptTable, timeInterval);
  }
}
